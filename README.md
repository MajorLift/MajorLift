...
That said, measurement is bounded by conceptualization and instrumentation. Type systems, by contrast, provide structural guarantees that cover our blindspots. This is why with TypeScript, I've dug deeper into its purely functional type-level domain than might be practical or wise. But now that verification is at the top of everyone's minds, that interest appears not to have been idle or misplaced after all.

My favorite part of this job is the same thing I love about music (and types): different voices coming together to form unexpected, intricate, beautiful structures.
